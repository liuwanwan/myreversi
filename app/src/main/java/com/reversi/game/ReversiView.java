...
import com.reversi.bean.Move;
import com.reversi.utils.Constant;
import com.reversi.utils.Util;
...
public class ReversiView extends SurfaceView implements Callback {
    ...
    public void render(Canvas canvas) {
        ...
        paint1.setColor(Color.rgb(255,227,132));
        canvas.drawRect(0,0,chessBoardRight+margin,chessBoardBottom+margin,paint1);
        paint1=null;
    ...
    private void loadChesses(Context context) {
        ...
        images[0] = loadBitmap(a, a, ContextCompat.getDrawable(context, R.drawable.black1));
        images[1] = loadBitmap(a, a, ContextCompat.getDrawable(context, R.drawable.black2));
        images[2] = loadBitmap(a, a, ContextCompat.getDrawable(context, R.drawable.black3));
        images[3] = loadBitmap(a, a, ContextCompat.getDrawable(context, R.drawable.black4));
        images[4] = loadBitmap(a, a, ContextCompat.getDrawable(context, R.drawable.black5));
        images[5] = loadBitmap(a, a, ContextCompat.getDrawable(context, R.drawable.black6));
        images[6] = loadBitmap(a, a, ContextCompat.getDrawable(context, R.drawable.black7));
        images[7] = loadBitmap(a, a, ContextCompat.getDrawable(context, R.drawable.black8));
        images[8] = loadBitmap(a, a, ContextCompat.getDrawable(context, R.drawable.black9));
        images[9] = loadBitmap(a, a, ContextCompat.getDrawable(context, R.drawable.black10));
        images[10] = loadBitmap(a, a, ContextCompat.getDrawable(context, R.drawable.black11));
        images[11] = loadBitmap(a, a, ContextCompat.getDrawable(context, R.drawable.white1));
        images[12] = loadBitmap(a, a, ContextCompat.getDrawable(context, R.drawable.white2));
        images[13] = loadBitmap(a, a, ContextCompat.getDrawable(context, R.drawable.white3));
        images[14] = loadBitmap(a, a, ContextCompat.getDrawable(context, R.drawable.white4));
        images[15] = loadBitmap(a, a, ContextCompat.getDrawable(context, R.drawable.white5));
        images[16] = loadBitmap(a, a, ContextCompat.getDrawable(context, R.drawable.white6));
        images[17] = loadBitmap(a, a, ContextCompat.getDrawable(context, R.drawable.white7));
        images[18] = loadBitmap(a, a, ContextCompat.getDrawable(context, R.drawable.white8));
        images[19] = loadBitmap(a, a, ContextCompat.getDrawable(context, R.drawable.white9));
        images[20] = loadBitmap(a, a, ContextCompat.getDrawable(context, R.drawable.white10));
        images[21] = loadBitmap(a, a, ContextCompat.getDrawable(context, R.drawable.white11));
    }
